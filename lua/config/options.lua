...
opt.spelllang = { "en" }     -- LazyVim: spell check language
...
opt.iskeyword:append("-")   -- ThePrimeagen: treat kebab-case as one word
opt.list = true               -- kickstart.nvim: show some hidden characters
opt.listchars = { tab = "» ", trail = "·", nbsp = "␣" }
opt.autowrite = true          -- LazyVim: auto write when leaving buffer
...
-- Provider optimization (LazyVim/kickstart.nvim: disable unused providers)
g.loaded_perl_provider = 0
g.loaded_ruby_provider = 0
g.loaded_node_provider = 0
g.loaded_python3_provider = 0

-- Status column (signs + line numbers + folds — provided by snacks.nvim)
